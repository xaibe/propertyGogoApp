...
const UserPassword = React.lazy(() =>
  import(/* webpackChunkName: "user-reset-password" */ './user-password')
);
    ...
    <UserLayout>
      <Suspense fallback={<div className="loading" />}>
        <Switch>
          ...
          />
          <Route
            path={`${match.url}/user-password/:hash/:email`}
            render={(props) => <UserPassword {...props} />}
          />
