  ...
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        to: `${adminRoot}/settings/my-profile`,
      },
      {
        icon: 'iconsminds-project',
        label: 'menu.company-profile',
        to: `${adminRoot}/settings/company-profile`,
      },
      {
        icon: 'iconsminds-data-center',
        label: 'menu.interface',
        to: `${adminRoot}/settings/interface`,
      },
      {
        icon: 'iconsminds-receipt-4',
        label: 'menu.tamplates',
        to: `${adminRoot}/settings/tamplates`,
      },
      {
        icon: 'iconsminds-wrench',
        label: 'menu.services',
        to: `${adminRoot}/settings/services`,
      },
      {
        icon: 'simple-icon-bubbles',
        label: 'menu.tags',
        to: `${adminRoot}/settings/tags`,
      },
    ],
  },
  {
